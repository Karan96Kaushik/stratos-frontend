...
export default {
    developer: {
        ...
        texts:[
            ...
            {label:"Lead Rating", id:"leadRating", multiSelect:true, options: ["", 1,2,3,4,5], type:"number", isRequired:true},
            {label:"Lead Source", id:"leadSource", multiSelect:true, options:leadSourceOptions, isHidden:false},
            ...
            {label:"Status", id: "status", multiSelect:true, options: statusOptions},
    ...
    agent: {
        ...
        texts:[
            ...
            {label:"Other Services", id:"service", multiSelect:true, options:["","Training", "Legal Documents", "Others"], isHidden:false},
            {label:"Type", id:"type", multiSelect:true, options:["","Individual", "Other than Individual"], isHidden:false},
            {label:"Location", id:"location", isHidden:false},
            {label:"Status", id: "status", multiSelect:true, options: statusOptions},
            {label:"Service Type", id: "serviceType", option:["", 'RERA Registration', 'Other Services'], isHidden:false},

            {label:"Lead Rating", id:"leadRating", multiSelect:true, options: ["",1,2,3,4,5], type:"number"},
            {label:"Lead Source", id:"leadSource", multiSelect:true, options:leadSourceOptions, isHidden:false},
            {label:"Lead Responsibility", id:"leadResponsibility", isHidden:false},
            {label:"FollowUp Date", id:"followUpDate", type:"date"},
            {label:"Closure Status", id:"closureStatus", multiSelect:true, options:closureStatusOptions},
    ...
    litigation: {
        ...
        texts:[
            ...
            {label:"Type", id:"type", multiSelect:true, options:["","Complainant", "Respondant"], isRequired:true, isHidden:false},
            {label:"Category", id:"category", multiSelect:true, options:["","Developer", "Buyer"], isRequired:true, isHidden:false},
            {label:"Service", id:"service", multiSelect:true, options:["","Package","Indivudal Service","Retainer Service"], isHidden:false},
